    ...
    if (scrollY > sectionTop && scrollY <= sectionTop + sectionHeight) {
      ...
      if (window.innerHeight + window.scrollY >= document.body.offsetHeight) {
        document
          ...
          .children[3].firstElementChild.classList.remove('active-link');
        document
          .querySelector('.nav__list')
          .children[4].firstElementChild.classList.add('active-link');
      } else {
        document
          .querySelector('.nav__list')
          .children[4].firstElementChild.classList.remove('active-link');
      }
    } else {
      document
        .querySelector('.nav__menu a[href*=' + sectionId + ']')
...
const projects = [
  {
    ...
    url: 'https://github.com/stanleyz94/vue-ecommerce-shop',
  },
  {
    modal: 'modal-second',
    img_large: 'img/work9_large.png',
    img: 'img/work9.jpg',
    description:
      'Demonstrates a way of organizing Selenium Tests Using the Page Object Model for testing a simple registration page on wizzair.com',
    url: 'https://github.com/stanleyz94/selenium-page-object-model-javascript',
  },
  {
    modal: 'modal-third',
    img_large: 'img/work8_large.png',
    img: 'img/work8.jpg',
    description:
      'Simple COVID-19 App created with Vue & Vuetify, which fetches data from API and shows data in a graphs.',
    url: 'https://github.com/stanleyz94/vuetify-covid-app',
  },
  {
    modal: 'modal-fourth',
    ...
    img: 'img/work1.jpg',
    description:
      'Application that request JSON object from the API to generate 12 random users. Clicking the user’s image or name will open a modal window with more detailed information. <br> Built using vanilla JavaScript, HTML, CSS.',
  ...
  },
  {
    ...
    img: 'img/work2.jpg',
    description:
      'Web dashboard that uses JavaScript library Chart.js for data visualization and Local storage to save the settings. <br> Built using vanilla JavaScript, HTML, CSS, and localStorage',
  ...
  },
  {
    ...
    img: 'img/work3.jpg',
    description:
      'A word guessing game where players will click letters from an onscreen keyboard to try to guess a random phrase. <br>Built using vanilla JavaScript.',
